...
--o-silva-sequences silva_138.2_SSU_NR99_RNA-seqs.qza \
--o-silva-taxonomy silva_138.2_SSU_NR99_tax.qza

qiime rescript cull-seqs \
--i-sequences silva_138.2_SSU_NR99_RNA-seqs.qza \
--o-clean-sequences silva_138.2_SSU_NR99_RNA-seqs_cleaned.qza

qiime rescript filter-seqs-length-by-taxon \
--i-sequences silva_138.2_SSU_NR99_RNA-seqs_cleaned.qza \
--i-taxonomy silva_138.2_SSU_NR99_tax.qza \
--p-labels Archaea Bacteria \
--p-min-lens 900 1200 \
--o-filtered-seqs silva_138.2_SSU_NR99_RNA-seqs-filtered.qza \
--o-discarded-seqs silva_138.2_SSU_NR99_RNA-seqs-discard.qza

qiime rescript dereplicate \
--i-sequences silva_138.2_SSU_NR99_RNA-seqs-filtered.qza \
--i-taxa silva_138.2_SSU_NR99_tax.qza \
--p-mode 'uniq' \
--o-dereplicated-sequences silva_138.2_SSU_NR99_RNA-seqs_dereplicated_uniq.qza \
--o-dereplicated-taxa silva_138.2_SSU_NR99_tax_dereplicated_uniq.qza
...
--o-classifier silva_138.2_SSU_NR99_classifier.qza
